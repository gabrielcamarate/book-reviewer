...
class PreviewHealthTest(unittest.TestCase):
    ...
    def test_handler_runs_simple_home_copyedit_action(self) -> None:
        ...
        translation_preview_calls: list[str] = []
        ...
        handler = build_handler(
            ...
            lambda: {"ok": True, "blocking_count": 0, "advisory_count": 0, "blocking_findings": [], "advisory_findings": []},
            None,
            translation_preview_action=lambda chunk_id: translation_preview_calls.append(chunk_id) or {"chunk_id": chunk_id},
        )
        ...
        self.assertEqual(translation_preview_calls, ["chapter-0001-conexao-dimensional-chunk-0001"])
    ...
    def test_handler_runs_simple_home_reject_action(self) -> None:
        rejection_calls: list[tuple[str, str]] = []
        ...
        handler = build_handler(
            ...
            lambda: {"ok": True, "blocking_count": 0, "advisory_count": 0, "blocking_findings": [], "advisory_findings": []},
            None,
            rejection_action=lambda chunk_id, reason: rejection_calls.append((chunk_id, reason)) or {"chunk_id": chunk_id, "reason": reason},
        )

        request = object.__new__(handler)
        request.path = "/api/simple-home/reject"
        payload = b'{"reason":"Mudou demais a voz do autor."}'
        ...
        self.assertEqual(
            rejection_calls,
            [("chapter-0001-conexao-dimensional-chunk-0001", "Mudou demais a voz do autor.")],
        )
