...
- Evidence: Observed in `137` approved paragraphs, including `chapter-0001-conexao-dimensional-p-0005`, `chapter-0001-conexao-dimensional-p-0006`, `chapter-0001-conexao-dimensional-p-0007`.
...
- Evidence: Observed in `193` approved paragraphs, including `frontmatter-0005-prefacio-p-0001`, `frontmatter-0005-prefacio-p-0002`, `frontmatter-0005-prefacio-p-0005`.
- Operational rule: Treat `—` and `―` as meaningful structural punctuation used for apposition, attribution beats, and conceptual emphasis.

### 4. Preserve uppercase acronyms and institutional short forms.
- Evidence: Recurring approved tokens include `SEU` (53), `IMSD` (29), `SPA` (11), `PREPARADO` (9), `CGU` (6).
